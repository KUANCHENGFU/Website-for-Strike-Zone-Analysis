...
class InputForm(Form):
    ...
    PitcherSide = SelectField(
        label='Pitcher Side:',
        # choices is (value, label) pairs: label gets printed
        # value is form.PitcherSide.data
        choices=[('Right', 'Right'),
                 ('Left', 'Left')],
        default='Right'
        )
